...
define(['./workbox-635a14b2'], (function (workbox) { 'use strict';
  ...
  workbox.precacheAndRoute([{
    "url": "/offline.html",
    "revision": "0.banu4mav8og"
  }], {});
  workbox.cleanupOutdatedCaches();
  workbox.registerRoute(new workbox.NavigationRoute(workbox.createHandlerBoundToURL("/offline.html"), {
    allowlist: [/^\/$/],
    denylist: [/^\/_/, /\/[^/?][^./?]*\.[^/]+$/, /^\/sw\.js$/, /^\/workbox-.*\.js$/]
  }));
  workbox.registerRoute(/^https:\/\/.*\.(?:js|css|png|svg|ico|woff2?)$/, new workbox.CacheFirst({
  ...
  workbox.registerRoute(({
    url
  }) => url.pathname.startsWith("/src/") || url.pathname.endsWith(".tsx"), new workbox.NetworkFirst({
